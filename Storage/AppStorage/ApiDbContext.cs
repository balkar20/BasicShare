...
public class ApiDbContext : DbContext
{
    ...
    public DbSet<MotorControlsModuleEntity> MotorControlsModules { get; set; }
    public DbSet<CameraModuleEntity> CameraModules { get; set; }
    
public DbSet<PowerSupplyEntity> PowerSupplys { get; set; }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // modelBuilder.Entity<ProductEntity>().HasData(new ProductEntity { clear
        // Id = 1, Description = "Desc", Name = "Tit" });
