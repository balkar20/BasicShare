...
public class PowerSupplyApiConfiguration: BaseConfiguration, IPowerSupplyApiConfiguration
{
    
    public PowerSupplyApiConfiguration(Func<string, string?> getConfigFunc) : base(getConfigFunc)
    {
    }
