...
public class DummyApiConfiguration: BaseConfiguration, IDummyApiConfiguration
{
    
    public DummyApiConfiguration(Func<string, string?> getConfigFunc) : base(getConfigFunc)
    {
    }
