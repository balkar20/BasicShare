...
public class CameraModuleApiConfiguration: BaseConfiguration, ICameraModuleApiConfiguration
{
    
    public CameraModuleApiConfiguration(Func<string, string?> getConfigFunc) : base(getConfigFunc)
    {
    }
