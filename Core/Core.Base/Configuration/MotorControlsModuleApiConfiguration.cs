...
public class MotorControlsModuleApiConfiguration: BaseConfiguration, IMotorControlsModuleApiConfiguration
{
    
    public MotorControlsModuleApiConfiguration(Func<string, string?> getConfigFunc) : base(getConfigFunc)
    {
    }
